...
contract SFBToken is ERC20, Orchestrated {
    ...
    constructor() ERC20("SFB", "SFB") {
        transferWhite[_msgSender()] = true;
        transferWhite[0x000000000000000000000000000000000000dEaD] = true;
        transferLimit = true;
        orchestrate(_msgSender(),0x84229e67);
        orchestrate(_msgSender(),0x39b22120);
    }

    //0x84229e67
    function contractMint(address account, uint amount) public onlyOrchestrated("onlyOrchestrated: contractMint") {
        ERC20._mint(account, amount);
    }

    //0x39b22120
    function contractBurn(address account, uint256 amount) public onlyOrchestrated("onlyOrchestrated: account") {
